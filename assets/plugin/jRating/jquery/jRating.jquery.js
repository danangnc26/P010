...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars **/
			bigStarsPath : 'assets/plugin/jRating/jquery/icons/stars.png', // path of the icon stars.png
			smallStarsPath : 'assets/plugin/jRating/jquery/icons/small.png', // path of the icon small.png
